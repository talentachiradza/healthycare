        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className='md:col-span-2'>
            <div className="flex items-center gap-5">
              ...
              <div>
                <span className='bg-obgColor text-secondaryColor py-1 px-6 lg:py-2 lg:px-6 text-[12px]
            ...
            <div className="mt-[50px] border-b border-solid border-secondaryColor">
              <button 
