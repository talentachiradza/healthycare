...
const Signup = () => {
  ...
  const handleFileInputChange = async event => {
    ...
    setFormData({...FormData, photo: data.secure_url}) // update the photo field with the uploaded image url

      // late we will use cloudinary to upload the image file 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <input 
                ...
                className="w-full pr-4 py-3 border-b border-solid border-primaryColor focus:outline-none 
          ...
          <div className="mb-5 flex items-center justify-between">
            ...
            {selectedFile &&  (<figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor
              ...
              <div className='relative w-[130px] h-[50px]'>
                ...
                px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-secondaryColor text-headingColor font-semibold
